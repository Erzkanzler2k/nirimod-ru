...
class BindingsPage(BasePage):
    ...
    def build(self) -> Gtk.Widget:
        ...
        self._main_title = Gtk.Label(label="Горячие клавиши")
        self._main_title.set_xalign(0.0)
        self._main_title.add_css_class("title-1")
        title_vbox.append(self._main_title)

        self._kb_stats_header = Gtk.Label(label="Определение сочетаний клавиш...")
        ...
        self._add_btn.set_tooltip_text("Добавить сочетание клавиш")
    ...
    def _build_list_tab(self) -> Gtk.Widget:
        ...
        # Search
        search = Gtk.SearchEntry(placeholder_text="Фильтр сочетаний…")
    ...
    def _refresh_visualizer(self):
        ...
        self._kb_stats_header.set_label(f"Обнаружено активных сочетаний: {n_total}")
    ...
    def _show_bind_dialog(self, bind: dict | None, idx: int):
        dialog = Adw.Dialog(title="Изменить сочетание" if bind else "Добавить сочетание")
