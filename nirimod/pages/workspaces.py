...
class WorkspacesPage(BasePage):
    def build(self) -> Gtk.Widget:
        ...
        self._grp = Adw.PreferencesGroup(
            title="Именованные рабочие пространства",
            description="Именованные рабочие пространства открываются сразу при запуске niri",
        )
    ...
    def _rebuild(self):
        ...
        def _on_outputs(outputs_data):
            ...
            new_grp = Adw.PreferencesGroup(
                title="Именованные рабочие пространства",
                description=f"Рабочих пространств: {len(ws_nodes)}",
            )
    ...
    def _make_ws_row(
        ...
        name_row = Adw.EntryRow(title="Название")
    ...
    def _on_add(self, *_):
        dialog = Adw.AlertDialog(
            heading="Добавить рабочее пространство",
            body="Введите название для нового рабочего пространства.",
        )
        entry = Adw.EntryRow(title="Название рабочего пространства")
